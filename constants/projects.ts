export const projects = [
  ...
  },
  {
    ...
    description:
      "Sitio web para informar sobre el Plan de Inversiones de Infraestructura, Movilidad y espacio público de Peñaflor. Cuenta con información actualizada y glosario.",
